  ...
  return (
    <div className="  ">
      <div className='flex flex-col items-center py-20  bg-light max:md:px-4'>
        <Title title="Available Cars " subTitle=" Brows our portfolio of car for your next adventure trips and plannings "/>
      ...
      <div className='  px-6 md:px-16 lg:px-24 xl:px-32 mt-10 '>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-4 xl:px-24 max-w-7xl mx-auto '>
